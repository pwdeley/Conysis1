...
<script type="text/javascript" src="css/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Rendimiento Javier Paredes Peluqueria & Make up', titleTextStyle: {color: 'green'},
...
<script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Tendencia Impuesto al Valor Agregado - IVA Javier Paredes Peluqueria & Make up', titleTextStyle: {color: 'green'},
          hAxis: {title: 'Meses 2021',  titleTextStyle: {color: 'red'}},
          vAxis: {minValue: 0},
          backgroundColor: '#eafaf1',
          width: 1000,
 ...
 <body>
     ...
     <div class="menu">
       ...
       <div class="item">
         ...
         <div class="sub-menu">
             ...
             <a href="ingresosJP/lista_ventas.php" class="sub-item">&#128209; Reporte Ventas</a>
   ...
   <section class="main">
      <div>
       <img alt="" src="imagenesEA/senoritahorizontal.png">
       </div>
