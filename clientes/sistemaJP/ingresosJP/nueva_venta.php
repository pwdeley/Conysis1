            ...
            <form  action="insertarfacturaV.php" class="datosfacturaV" method="POST" enctype="multipart/form-data">
                ...
                <thead>
                    ...
                    <tr> 
                        ...
                        <td><input type="number" step="any" name="txt_precio1" id="txt_precio1" oninput="calcular()" value="0" min="1" class="textright" disabled></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" step="any" name="txt_precio2" id="txt_precio2" oninput="calcular()" value="0" min="1" class="textright" disabled></td>
...
<script type="text/javascript">
    function calcular() {
        try {
            ...
            document.getElementById("txt_iva_ventas1").value = ((a * b) * 0).toFixed(2);
            document.getElementById("txt_iva_ventas2").value = ((c * d) * 0).toFixed(2);
            document.getElementById("txt_precio_total1").value = ((a * b) * 1).toFixed(2);
            document.getElementById("txt_precio_total2").value = ((c * d) * 1).toFixed(2);
            document.getElementById("txt_iva_total").value = (((a * b) + (c * d)) * 0).toFixed(2);
            document.getElementById("txt_precio_total").value = (((a * b ) + (c * d)) * 1).toFixed(2);
        } catch (e) {}
 }
</script>
