...
<head>
    ...
    <title>Declaración de IVA EA</title>
...
<nav>
    ...
    <div class="item">
        <a href="../../Fact/web/app.php"><i>&#128587;</i>Cerrar Sesión</a>
    </div>

</nav>
<section id="container">

    <h1>&#128210; Detalle Declaración de IVA Eadepor  </h1><br><br>

    <div>

        <h5>Ingrese la fecha a declarar</h5><br>

        <form action="declaracion_iva.php" method="get" class="form_search_date">
...
$suma1 = mysqli_query($conection,"SELECT SUM(totalSinImpuestos) as mtotal1 FROM factura WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row1 = mysqli_fetch_array($suma1,MYSQLI_ASSOC);

$suma2 = mysqli_query($conection,"SELECT SUM(totalSinImpuestos) as mtotal2 FROM notacredito WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row2 = mysqli_fetch_array($suma2,MYSQLI_ASSOC);

$suma3 = mysqli_query($conection,"SELECT SUM(iva12) as mtotal3 FROM factura WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row3 = mysqli_fetch_array($suma3,MYSQLI_ASSOC);

$suma4 = mysqli_query($conection,"SELECT SUM(iva12) as mtotal4 FROM notacredito WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row4 = mysqli_fetch_array($suma4,MYSQLI_ASSOC);


    
$suma5 = mysqli_query($conection,"SELECT SUM(subTotalIva0) as mtotal5 FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row5 = mysqli_fetch_array($suma5,MYSQLI_ASSOC);

$suma6 = mysqli_query($conection,"SELECT SUM(subTotalIva12) as mtotal6 FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row6 = mysqli_fetch_array($suma6,MYSQLI_ASSOC);

$suma7 = mysqli_query($conection,"SELECT SUM(iva12) as mtotal7 FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row7 = mysqli_fetch_array($suma7,MYSQLI_ASSOC);

$suma8 = mysqli_query($conection,"SELECT SUM(valorTotal) as mtotal8 FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row8 = mysqli_fetch_array($suma8,MYSQLI_ASSOC);


    
$suma10 = mysqli_query($conection,"SELECT SUM(rir) as mtotal10 FROM retenciones WHERE fechaemis BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row10 = mysqli_fetch_array($suma10,MYSQLI_ASSOC);

$suma11 = mysqli_query($conection,"SELECT SUM(riva) as mtotal11 FROM retenciones WHERE fechaemis BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

$row11 = mysqli_fetch_array($suma11,MYSQLI_ASSOC);



$suma12 = mysqli_query($conection,"SELECT SUM(iva12) as mtotal12 FROM factura WHERE fechaEmision BETWEEN '2022-01-01' AND '$fecha_a' AND emisor_id = 3");

$row12 = mysqli_fetch_array($suma12,MYSQLI_ASSOC);

$suma13 = mysqli_query($conection,"SELECT SUM(iva12) as mtotal13 FROM compra WHERE fechaEmision BETWEEN '2022-01-01' AND '$fecha_a' AND emisor_id = 3");

$row13 = mysqli_fetch_array($suma13,MYSQLI_ASSOC);

$suma15 = mysqli_query($conection,"SELECT SUM(riva) as mtotal15 FROM retenciones WHERE fechaemis BETWEEN '2023-01-01' AND '$fecha_a' AND emisor_id = 3");
...
<tr>
    ...
    <th>Resumen de Ventas</th>
    <th class="textright">Casillero</th>
    <th class="textright">Ventas Brutas</th>
    <th class="textright">Casillero</th>
    <th class="textright">Ventas Netas</th>
    <th class="textright">Casillero</th>
...
<tr>
    ...
    $sql_registe = mysqli_query ($conection, "SELECT COUNT(*) as total_registro FROM factura WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");
    ...
    <tr>
        ...
        <th class="textright">Casillero</th>
        <th class="textright">Compras Brutas</th>
        <th class="textright">Casillero</th>
        <th class="textright">Compras Netas</th>
        <th class="textright">Casillero</th>
        <th class="textright">IVA 12%</th>
...
<tr>
    ...
    <td class="textright"><?php 
            $sql_registe1 = mysqli_query ($conection, "SELECT COUNT(*) as total_registro1 FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");

            $result_register1 = mysqli_fetch_array ($sql_registe1);
    
            $total_registro1 = $result_register1 ['total_registro1'];
    
    echo $total_registro1; ?></th>
</tr>
...
<tr>
    ...
    <th class="textright"><?php  
        if(($row3["mtotal3"])-($row4["mtotal4"])-($row7["mtotal7"])-($row11["mtotal11"])>0){
            echo number_format(($row3["mtotal3"])-($row4["mtotal4"])-($row7["mtotal7"])-($row11["mtotal11"]),2,',', '.');    
        }else{
            echo number_format(0,2,',', '.');        
        } ?></th>
</tr>
    ...
    <table>
        ...
        $query = mysqli_query($conection,"SELECT f.secuencial,f.formaPago,f.fechaEmision,f.totalSinImpuestos,
              ...
              ON f.id = q.factura_id
                ...
                WHERE f.fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND f.emisor_id = 3
        ...
        if ($result > 0){
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr id="row_<?php echo $data["id"]; ?>">
                    ...
                    <td><?php echo utf8_encode($data["cliente"]); ?></td>

                    <td><?php echo utf8_encode($data["nombre"]); ?></td>
                    
                    <td><?php echo utf8_encode($data["observacion"]); ?></td>
...
<tr>
        ...
        <tr>
            <th>Total USD Ventas Netas de: <br>
            ...
            <th class="textright"><?php echo number_format(($row3["mtotal3"])-($row4["mtotal4"]),2,',', '.'); ?></th>
...
$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM compra WHERE fechaEmision BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3 ");
...
<tr id="row_<?php echo $data["fechaEmision"]; ?>">
    ...
    <td><?php echo utf8_encode($data["razonSocialProveedor"]); ?></td>
    <td><?php echo utf8_encode($data["nombre"]); ?></td>
...
$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM retenciones WHERE fechaemis BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3 ");
...
$query = mysqli_query($conection,"SELECT noretencion,fechaemis,razonSocialAgenteRetencion,
                                         baseimp,riva,rir,facturaQueAplica,archivo,emisor_id
                                         
      FROM retenciones

      WHERE fechaemis BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3 
...
<tr id="row_<?php echo $data["fechaemis"]; ?>">
    ...
    <td><?php echo utf8_encode($data["razonSocialAgenteRetencion"]); ?></td>
...
<tr>
    ...
    <th> Total Retenciones Recibidas: <?php
        ...
        $sql_registe2 = mysqli_query ($conection, "SELECT COUNT(*) as total_registro2 FROM retenciones WHERE fechaemis BETWEEN '$fecha_de' AND '$fecha_a' AND emisor_id = 3");
