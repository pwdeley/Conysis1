...
<head>
	...
	<title>Lista de Proveedores EA</title>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT * FROM proveedor 
                                            WHERE estatus = 1 ORDER BY nombreprovee ASC LIMIT $desde,$por_pagina 
				");
				...
				<tr>
					...
					<td>
                        ...
                        <?php if($_SESSION['rol'] == 1 /*para incluir a usuarios rol 2 o 3 que puedan eliminar clientes: || $_SESSION['rol'] == 2  */){ ?>
                            |
                            <a class="link_delete" href="eliminar_confirmar_proveedor.php?id=<?php echo $data["rucproveedor"];
                            ?>">Eliminar</a>
                        <?php } ?>
					</td>
				</tr>
