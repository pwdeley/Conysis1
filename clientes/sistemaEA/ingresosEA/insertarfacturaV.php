...
//    if ( isset($_POST['txt_iva_total']) || isset($_POST['txt_precio_total']) )
  ...
  //  }
    ...
    if($_FILES["archivo"]) {
        ...
        if($subirarchivo){
            $insertarSQL = "INSERT INTO facturaV(usuario, codcliente, fechaemis, codprod1, codprod2, precio1, cantidad1, precio2, cantidad2, formacobro, archivo)
            VALUES ('$usuario_id','$ruccliente','$fechaemis','$codigoprod1','$codigoprod2','$precioventa1','$cantidadv1','$precioventa2','$cantidadv2','$formacobro','$ruta')";
