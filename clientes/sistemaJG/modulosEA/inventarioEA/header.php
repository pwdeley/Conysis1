...
<header>
   ...
   <div class="side-bar">
     ...
     <div class="menu">
       <div class="item"><a href="../../index.php"><img class="close" src="img/salir.png" alt="Salir del sistema" title="Salir">  Cerrar Sesión</a></div>
       <div class="item">
	   ...
	   <div class="item">
         ...
         <div class="sub-menu">
           <a href="registro_producto.php" class="sub-item">&#128230; Nuevos Art.</a>
           <a href="lista_producto.php" class="sub-item">&#127857; Productos</a>
        </div>
       </div>
   </div>
   </div>
